...
| [![Tests: 289 files](https://img.shields.io/badge/Tests-289%20files-brightgreen)](tests)|
...
| - 289 test files in `tests/` (33 fixtures) |
...
The test suite includes **289 test files** covering:
