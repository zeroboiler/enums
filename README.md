...
| [![Tests: 330 files](https://img.shields.io/badge/Tests-330%20files-brightgreen)](tests)|
...
| - 330 test files in `tests/` (33 fixtures) |
...
The test suite includes **330 test files** covering:
