...
|[![Tests: 196](https://img.shields.io/badge/Tests-196-brightgreen)]()
...
- 196 test files in `tests/` (22 fixtures)
...
The test suite includes **196 test files** (174 unit tests + 22 fixtures) covering:
