...
[![Tests: 202](https://img.shields.io/badge/Tests-202-brightgreen)]()
...
|- 202 test files in `tests/` (22 fixtures)
...
The test suite includes **202 test files** (202 unit tests + 22 fixtures) covering:
