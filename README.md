...
|[![Tests: 204](https://img.shields.io/badge/Tests-204-brightgreen)]()
...
|- 204 test files in `tests/` (22 fixtures)
...
The test suite includes **204 test files** (204 unit tests + 22 fixtures) covering:
