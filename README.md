...
|[![Tests: 199](https://img.shields.io/badge/Tests-199-brightgreen)]()
...
- 199 test files in `tests/` (22 fixtures)
...
The test suite includes **199 test files** (177 unit tests + 22 fixtures) covering:
