...
| [![Tests: 328 files](https://img.shields.io/badge/Tests-328%20files-brightgreen)](tests)|
...
| - 328 test files in `tests/` (33 fixtures) |
...
The test suite includes **328 test files** covering:
