...
|||[![Tests: 251](https://img.shields.io/badge/Tests-251-brightgreen)]()
||||[![Version 1.0.36](https://img.shields.io/badge/Version-1.0.36-green)](https://github.com/zeroboiler/enums/releases)
...
|- 251 test files in `tests/` (30 fixtures)
...
The test suite includes **237 test files** (235 unit tests + Pest.php + bootstrap.php) covering:
