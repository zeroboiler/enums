...
describe('EnumCast Edge Cases', function (): void {
    ...
    describe('set() edge cases', function (): void {
        ...
        it('throws InvalidArgumentException for wrong enum instance in set()', function (): void {
            $cast = new EnumCast(UserStatus::class);
        ...
        it('throws with descriptive message for wrong enum instance', function (): void {
            $cast = new EnumCast(UserStatus::class);
            ...
            expect(fn (): mixed => $cast->set(
                ...
                fn (InvalidArgumentException $e): bool => str_contains($e->getMessage(), UserStatus::class)
                    && str_contains($e->getMessage(), Priority::class)
            );
        });
