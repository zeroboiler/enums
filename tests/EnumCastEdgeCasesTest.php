...
describe('EnumCast Edge Cases', function (): void {
    ...
    describe('set() edge cases', function (): void {
        ...
        it('throws InvalidArgumentException for wrong enum class instance in set()', function (): void {
            ...
            // must throw — accepting it would cause silent data corruption (Issue #20)
            expect(fn (): mixed => $cast->set(
                model: new class {},
                key: 'status',
                value: Priority::HIGH,
        ...
        it('throws for wrong enum with matching value type in set()', function (): void {
            $cast = new EnumCast(Priority::class);

            // Both are int-backed but different enums
            expect(fn (): mixed => $cast->set(
                model: new class {},
                key: 'priority',
